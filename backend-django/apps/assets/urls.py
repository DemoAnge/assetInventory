...
from .views import AssetViewSet, BrandViewSet, AssetTypeViewSet, AssetModelViewSet, AccountCodeViewSet
...
router.register(r"account-codes",  AccountCodeViewSet, basename="account-code")
